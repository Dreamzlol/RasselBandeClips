...
<main class="container flex flex-col">
	<section class="flex h-screen flex-col items-center justify-center" use:reveal={{ duration: 500, reset: true }}>
		<div class="py-32 sm:py-48 lg:py-56">
			<h1
				class="text-stroke border-2 border-black bg-[#FFA6F6] p-8 text-center text-4xl font-bold text-white shadow-[6px_6px_0px_rgba(0,0,0,1)] md:text-8xl"
			>
				Die Rasselbande<br />Clips of the Month!
			</h1>
			<p class="px-8 pt-8 text-center text-lg font-normal text-black">
				Die besten Clips der letzten Monate, des heutigen Tages und aller Zeiten.
			</p>
		</div>
	...
	<section id="clipsOfTheMonth" class="flex h-screen flex-col items-center justify-center">
		<div class="flex flex-col items-center justify-center" use:reveal={{ duration: 500, reset: true }}>
			<h1 class="text-stroke text-4xl font-bold text-white md:text-8xl">Clips of the Month</h1>
	...
	<section class="flex flex-col items-center justify-center">
		<div class="relative flex items-center justify-center">
			<h2 class="text-stroke text-5xl font-bold text-white md:text-8xl" use:reveal={{ duration: 500, reset: true }}>
				Hall of Fame
			</h2>
			<Crown
				class="text-stroke absolute right-0 top-0 -mt-6 mr-4 flex h-10 w-10 items-end justify-end md:-mt-10 md:mr-12 md:h-20 md:w-20"
			/>
		</div>
		<div class="flex flex-col items-center justify-center" use:reveal={{ duration: 500, reset: true }}>
